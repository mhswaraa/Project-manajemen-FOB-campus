      ...
      <div class="max-w-4xl mx-auto">
        <div class="flex flex-col sm:flex-row justify-between items-start mb-8">
          <div>
            ...
            <p class="text-gray-500 mt-1">Perbarui detail untuk: <span class="font-semibold text-indigo-600">{{ $user->name }}</span></p>
          </div>
        ...
        <div class="bg-white p-8 rounded-xl shadow-md" x-data="{ role: '{{ old('role', $user->role) }}' }">
          <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Perbarui informasi dasar pengguna.</p>
            </div>
            ...
            <div>
              ...
              <select name="role" id="role" x-model="role" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                  ...
                  <option value="penjahit" @if($user->role == 'penjahit') selected @endif>Penjahit</option>
              </select>
            ...
            <div x-show="role === 'investor' || role === 'penjahit'" x-transition>
                ...
                <x-text-input id="gdrive_link" name="gdrive_link" type="url" class="mt-1 block w-full" :value="old('gdrive_link', $user->investor->gdrive_link ?? $user->tailor->gdrive_link ?? '')" placeholder="https://drive.google.com/..." />
            ...
            {{-- Bagian Kredensial --}}
             <div class="border-t border-gray-200 pt-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Isi field di bawah hanya jika Anda ingin mengubah password.</p>
            </div>
