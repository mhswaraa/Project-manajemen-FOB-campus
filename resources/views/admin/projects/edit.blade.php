            ...
            <ul class="space-y-3 max-h-40 overflow-y-auto">
              @forelse ($project->investments as $investment)
                <li class="flex items-center gap-3 text-sm">
                    ...
                    <div>
                        <p class="font-medium text-gray-800">{{ $investment->investor->user->name }}</p>
                        <p class="text-xs text-gray-500">Investasi: {{ $investment->qty }} pcs</p>
                    </div>
                </li>
              @empty
