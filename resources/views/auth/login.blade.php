    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <!-- Ini adalah tempat untuk pesan status, seperti 'status' dari session -->
                <!-- <div class="mb-4 font-medium text-sm text-green-600">
                    {{ session('status') }}
                </div> -->

                <form method="POST" action="#">
                    <!-- CSRF Token (Penting untuk keamanan di Laravel) -->
                    <!-- @csrf -->
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" 
                               ...
                               required 
                               autofocus />
                        <!-- Tempat untuk pesan error validasi email -->
                        <!-- <p class="mt-2 text-sm text-red-600">{{ $errors->get('email') }}</p> -->
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="password" 
                               ...
                               placeholder="••••••••"
                               required />
                         <!-- Tempat untuk pesan error validasi password -->
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <a href="#" class="text-sm text-indigo-600 hover:text-indigo-500 hover:underline">
                            Lupa password?
                        </a>
                    </div>
                    ...
                    <!-- Link untuk Registrasi (Opsional) -->
